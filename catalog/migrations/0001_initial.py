# Generated by Django 2.2.5 on 2019-09-06 13:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a bok genre(e.g. Spiritual)', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Select a genere for this book', to='catalog.Genre'),
        ),
    ]
